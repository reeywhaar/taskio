import { CheckIcon, UndoIcon } from "@app/components/icons/Icon";
 ...
 *
 * Finishing a task lives at the right as a mark, and the left column is the selection's — see
 * docs/interface.md.
 *
...
export function TaskRow({
  ...
  return (
    <li
      ...
      className="flex cursor-pointer items-start gap-3 rounded-lg bg-surface px-3 py-2.5 hover:bg-fill"
    >
      {selectable ? (
